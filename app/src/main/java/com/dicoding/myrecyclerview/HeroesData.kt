...
object HeroesData {
    private val heroesNames = arrayOf("Ahmad Dahlan",
            "Ahmad Yani",
            "Sutomo",
            "Gatot Subroto",
            "Ki Hajar Dewantara",
    ...
    private val heroDetail = arrayOf("Salah seorang ulama dan khatib terkemuka di Masjid Besar Kasultanan Yogyakarta pada masa itu, dan ibu dari K.H. Ahmad Dahlan adalah puteri dari H. Ibrahim yang juga menjabat penghulu Kesultanan Ngayogyakarta Hadiningrat pada masa itu. KH. Ahmad Dahlan telah mempelopori kebangkitan ummat Islam untuk menyadari nasibnya sebagai bangsa terjajah yang masih harus belajar dan berbuat.",
    ...
    private val heroesImage = intArrayOf(R.drawable.ahmad_dahlan, R.drawable.ahmad_yani, R.drawable.bung_tomo, R.drawable.gatot_subroto, R.drawable.ki_hadjar_dewantara, R.drawable.mohammad_hatta, R.drawable.sudirman, R.drawable.sukarno, R.drawable.supomo, R.drawable.tan_malaka)

    val listData : ArrayList<Hero>
        get(){
            val list = arrayListOf<Hero>()
            for (position in heroesNames.indices){
                val hero = Hero()
                hero.name = heroesNames[position]
